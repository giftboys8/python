...
'You Kill Me   %s': 'You Kill Me   %s',
'You Kill Me?%s': 'You Kill Me?%s',
'You visited the url %s': 'You visited the url %s',
'你知道如何快速入门吗?': '你知道如何快速入门吗?',
'你知道如何配置元件吗?': '你知道如何配置元件吗?',
'元件配置': '元件配置',
'功能套': '功能套',
'地址：%s': '地址：%s',
'实例设置': '实例设置',
...
'查看性能实例': '查看性能实例',
'查看页面实例': '查看页面实例',
'欢迎使用自动化测试管理系统': '欢迎使用自动化测试管理系统',
'测试套': '测试套',
'点击查看实例': '点击查看实例',
'系统配置': '系统配置',
'自动化测试管理系统': '自动化测试管理系统',
'页面元件实例': '页面元件实例',
'顺丰人自动的自动化测试系统': '顺丰人自动的自动化测试系统',
'顺丰人自己的自动化测试系统': '顺丰人自己的自动化测试系统',
}
